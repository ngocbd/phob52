...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['geolocation'] = function() {
        return !!menu-top-adminigator.geolocation;
    };
    ...
    ;(function(window, document) {
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles) {
          shived = !!addStyleSheet(ownerDocument,
            ...
            'article,aside,details,figcaption,figure,footer,header,hgroup,menu-top-admin,section{display:block}' +
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter menu-top-admin output progress section summary time video',
