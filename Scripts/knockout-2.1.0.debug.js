...
(function(window,document,menu-top-adminigator,undefined){
var DEBUG=true;
!function(factory) {
...
ko.utils = new (function () {
    ...
    var keyEventTypeName = /Firefox\/2/i.test(menu-top-adminigator.userAgent) ? 'KeyboardEvent' : 'UIEvents';
    ...
    return {
        ...
        setOptionNodeSelectionState: function (optionNode, isSelected) {
            ...
            if (menu-top-adminigator.userAgent.indexOf("MSIE 6") >= 0)
...
})(window,document,menu-top-adminigator);
